                ...
                if (title !== null) {
                    ...
                    if (!comparaHistoryTitle(title)) {
                        ...
                        for (var i = 0; i < random(25, 35); i++) {
                            ...
                            var ex = className("android.widget.Image").depth(9).findOne(10)
                            exceptionWindowDispose()
                            if (ex !== null) {
                                ex.parent().click()
                            }
...
function clickHome() {
    toast("点击头条")
    var home = text("头条").depth(1).findOne(10000)
    if (home == null) {
        text("刷新").depth(1).findOne(10000).click()
    } else {
        home.click()
    }
...
function exceptionPlateCheck(onePlate) {
    ...
    } else if (onePlate.findOne(id("tv_news_three_picture_title")) == null && onePlate.findOne(id("tv_news_one_picture_title")) == null) {
